...
function actionVerb(action: string, t: (k: string) => string): string {
  const map: Record<string, string> = {
    ...
    tagged: 'tagged', tag_added: 'tagged', tag_removed: 'untagged',
    title_changed: 'renamed', description_changed: 'edited the description of',
    type_changed: 'changed the type of', category_changed: 'changed the category of',
    due_date_changed: 'changed the due date of', estimate_changed: 'changed the estimate of',
    sprint_changed: 'moved to another sprint', milestone_changed: 'changed the milestone of',
    parent_changed: 'changed the parent of', attachment_added: 'attached a file to',
    attachment_removed: 'removed a file from', snoozed: 'snoozed', unsnoozed: 'unsnoozed',
