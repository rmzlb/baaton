    ...
    >
      ...
      >
        ...
        >
          {t('landing.heroLine1')}
          <br />
          <span className="text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent">
            {t('landing.heroLine2')}
          </span>
        </motion.h1>
        ...
        <motion.div
          ...
          animate="visible"
          custom={5}
          className="mt-4 flex items-center gap-3 text-muted text-sm"
        >
